import { Directive, ElementRef, Input, Output, EventEmitter, OnInit, AfterViewChecked, AfterContentChecked, AfterViewInit } from "@angular/core";
...
export class ChartWrapperDirective implements OnInit {
    ...
    constructor(private elementRef: ElementRef, private chartDivService: ChartService) {
    ...
    drawWrapperChart(chartType, options, dataTable, el) {
